...
<body>
	...
	<form method="post" onsubmit="myaction.collect_data(event, 'login')">
		<div class="col-md-4 border rounded mx-auto mt-5 p-4 shadow">
			...
			<div><small class="my-1 js-error js-error-email text-danger">
				
			</small></div>

			<div class="input-group mb-3">
			  <span class="input-group-text" id="basic-addon1"><i class="bi bi-envelope"></i></span>
			  <input name="email" type="text" class="form-control p-3" placeholder="User id" >
			</div>
			<div class="input-group mb-3">
			...
			<div class="m-2"><b>
				Dont have an account?</b> <a href="signup.php">signup here</a>
			</div>
		</div>
	</form>
